...
pub fn set_global_template_keyboard(message: &Message)->SendMessageParams{
    ...
    let mut keyboard: Vec<Vec<InlineKeyboardButton>> = Vec::new();
       ...
       let create_link_item_description = InlineKeyboardButton::builder().text("Make bot item descriptions as the link to the feed page").switch_inline_query_current_chat("/set_global_template {{create_link bot_item_description bot_item_link }}").build();
       let create_link_item_name = InlineKeyboardButton::builder().text("Make bot item name as the link to the feed page").switch_inline_query_current_chat("/set_global_template {{create_link bot_item_name bot_item_link }}").build();
       let create_link_custom_name = InlineKeyboardButton::builder().text("Make custom name as the link to the feed page").switch_inline_query_current_chat("/set_global_template {{create_link \"custom_name\" bot_item_link }}").build();
